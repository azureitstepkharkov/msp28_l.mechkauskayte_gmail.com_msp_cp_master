...
--
-- Хост: 127.0.0.1:3306
-- Час створення: Чрв 16 2018 р., 04:05
...
('lolita@gmail.com', '$3y$10$Xi/pf0E60ypzaUH.uehlzO.BpQUNehAqM0wDAnUUcyHvdQvruLVQu', '2018-02-20 23:36:45'),
('ololololo@gmail.com', '$2y$10$hxxyIErGTBWSqmiXT1kDxOhzH2m4vHhZIzcpEQVd6DjtYH1OqKdYe', '2018-02-20 23:42:29');
...
(1, 'Project1', 'simple mobile game', 2, 'finished', '2017-12-01 22:10:46', '2017-12-01 22:10:46'),
(2, 'Project2', 'simple project for important customer', 2, 'finished', '2017-12-01 22:10:46', '2017-12-01 22:10:46'),
(3, 'shop', 'hgfghfghgfh', 2, 'in work', '2018-02-18 10:37:15', '2018-02-18 10:37:15'),
(4, '3445u3', 'r43o5i3u5ousdfsfsfs', 2, 'finished', '2018-02-18 10:38:46', '2018-02-18 10:38:46'),
(6, 'test', 'sdfsf', 10, 'finished', '2018-02-18 17:42:39', '2018-02-18 18:34:14'),
(8, 'qrqrwrw', 'test status', 2, 'finished', '2018-02-21 01:49:54', '2018-02-21 01:49:54'),
(9, 'test2', 'test', 8, 'canceled', '2018-06-13 21:00:00', '2018-06-15 21:00:00');

-- --------------------------------------------------------

--
-- Структура таблиці `project_technology`
--
...
--
-- Структура таблиці `project_user`
--
...
--
-- Дамп даних таблиці `project_user`
--
...
--
-- Структура таблиці `task_comment`
--
...
--
-- Дамп даних таблиці `task_comment`
--
...
--
-- Дамп даних таблиці `task_file`
--

INSERT INTO `task_file` (`id`, `task_id`, `path`, `created_at`, `updated_at`, `name`) VALUES
(1, 1, '111.jpg', '2017-12-01 22:10:46', '2017-12-01 22:10:46', ''),
(2, 2, '1222.jpg', '2017-12-01 22:10:46', '2017-12-01 22:10:46', ''),
(3, 1, 'rjns.jpg', NULL, NULL, 'rjns.jpg'),
(4, 27, 'other.jpg', '2018-02-21 03:52:51', '2018-02-21 03:52:51', 'other.jpg'),
(5, 28, 'Ljrevtynfwbz.docx', '2018-02-21 03:56:39', '2018-02-21 03:56:39', 'Ljrevtynfwbz.docx'),
(6, 29, 'uyrfj.txt', '2018-02-21 03:58:04', '2018-02-21 03:58:04', 'uyrfj.txt');

-- --------------------------------------------------------

--
-- Структура таблиці `task_technology`
--
...
--
-- Структура таблиці `technologies`
--
...
--
-- Дамп даних таблиці `technologies`
--
...
--
-- Структура таблиці `technology_user`
--
...
--
-- Дамп даних таблиці `technology_user`
--
...
(5, 'User_tl', 'lolita_tl@gmail.com', '$2y$10$Z8W6bN.LHGSwBKiKbOV18OyL3RJ.0sMKo5GTIiZD5HQN2FvpkDOO2', 'user.png', 'active', NULL, '2017-12-01 22:10:46', '2017-12-01 22:10:46'),
...
(7, 'lolita', 'lolita@gmail.com', '$2y$10$5knnTFBNJO2b6W8XlujMru9OfLkhtkr8RRRjf1u1rDotImoQN02zS', 'img.jpg', 'active', '8rsPtNRaaGr10M9siohmd6HtMsccEbfLws9PZ7RmX79q3a5grXPGhor9EcJv', '2017-12-12 22:55:06', '2017-12-20 00:43:32'),
(8, 'lolololo', 'ololol@gmail.com', '$2y$10$Ol9gTzfuMXColoRBXIzpIuTW9wvP5SZUYzyFdXegLrnR89erYjxve', 'olga.jpg', 'active', 'AD3cvvcwkaWzTu95FecF2SB9UyuDqslaDyJAGFlUka21cE4vesxBqnS5kpzA', '2018-02-13 20:02:53', '2018-05-21 22:57:04'),
...
(12, 'Real Name', 'ololololololo@gmail.com', '$3y$10$6/xdIaNyPFewyfOA2Iz0beHhbF0KEiKrFMmc5QNLs5YEcm9EKFZXi', NULL, 'active', 'D4fH0V9Unz4I0YCyGFigbXr8LjRvXIbddy2Vosj5G4dZ5ShxJm2aT30oavYD', '2018-02-20 23:39:19', '2018-02-20 23:39:19'),
...
--
-- Структура таблиці `user_comment`
--
...
--
-- Дамп даних таблиці `user_comment`
--
...
--
-- Індекси таблиці `project_technology`
--
...
--
-- Індекси таблиці `task_technology`
--
...
--
-- Індекси таблиці `technology_user`
--
...
--
-- AUTO_INCREMENT для таблиці `task_comment`
--
ALTER TABLE `task_comment`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT для таблиці `task_file`
--
ALTER TABLE `task_file`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT для таблиці `technologies`
--
ALTER TABLE `technologies`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
...
--
-- AUTO_INCREMENT для таблиці `user_comment`
--
ALTER TABLE `user_comment`
...
--
-- Обмеження зовнішнього ключа таблиці `project_technology`
--
ALTER TABLE `project_technology`
...
--
-- Обмеження зовнішнього ключа таблиці `project_user`
--
ALTER TABLE `project_user`
...
--
-- Обмеження зовнішнього ключа таблиці `technology_user`
--
ALTER TABLE `technology_user`
...
--
-- Обмеження зовнішнього ключа таблиці `user_comment`
--
ALTER TABLE `user_comment`
